    ...
    return rx.box(
            rx.box(
                ...
                rx.box(
                    ...
                    rx.box(
                        rx.box(
                            button('Insertar', '#83CBEB', None),
                            class_name='flex w-1/2 lg:w-auto'
                        ),
                        rx.box(
                            button('Eliminar', '#303235', None),
                            class_name='flex w-1/2 lg:w-auto'
                        ),
                        
                        class_name=f'flex justify-center items-center w-full lg:w-auto space-x-[{styles.Spacer.SMALL.value}]'
                    ),
